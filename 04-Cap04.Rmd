...
$\pi$-ponderado. Os resultados referentes à Região Metropolitana do Rio de Janeiro para algumas variáveis são apresentados na Tabela \@ref(tab:epakish1) a título de ilustração. Note que a população
...
names(tabela) <- c('Variável','Estimador Simples','Estimador de Razão','Estimador $\\pi$-ponderado')

knitr::kable(tabela,align= "lccc",format.args= list(big.mark = '.',dec=','),escape = F, booktabs=T,
...
Os valores apresentados na Tabela \@ref(tab:epakish1)  para a RM do Rio de Janeiro são similares aos observados para as demais RMs, se consideradas as mesmas variáveis. Nota-se grande variação dos valores do EPA, cujos valores mínimo e máximo são de 1,28 e 111,27
