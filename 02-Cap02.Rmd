...
```{r,modclas, echo=FALSE, fig.cap="$\\text{Representação esquemática da }\\textit{Modelagem Clássica}$",fig.align="center"}
knitr::include_graphics("Figuras/Figura2.1.png")
```

```{r, echo=FALSE, label=modelclass,fig.align="center"}
...
```{r,modamo, echo=FALSE, fig.cap="$\\text{Representação esquemática da }\\textit{Amostragem Probabilística}$",fig.align="center"}
...
```{r, modsup, echo=FALSE, fig.cap="$\\text{Representação esquemática da }\\textit{Modelagem de Superpopulação}$",fig.align="center"}
