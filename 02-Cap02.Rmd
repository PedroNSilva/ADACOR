...
```{r,label=modclas, echo=FALSE, fig.cap="$\\text{Representação esquemática da } \\textit{Modelagem Clássica}$",fig.align="center",out.width="50%"}
knitr::include_graphics("Figuras/Figura2.1.png")
```

```{r, echo=FALSE, label=modelclass,tab.align="center"}
suppressMessages(library(kableExtra))

l1=c('Dados Amostrais (observações) ','$y_1, \\ldots, y_n$')
l2=c('Modelo Paramétrico/ Hipóteses', '$Y_1, \\ldots , Y_n 
...
```{r, echo=FALSE, label=modelamo,fig.align="center"}
suppressMessages(library(kableExtra))
...
```{r,modamo, echo=FALSE, fig.cap="$\\text{Representação esquemática da }\\textit{Amostragem Probabilística}$", fig.align="center",out.width="50%"}
...
```{r, modsup, echo=FALSE, fig.cap="$\\text{Representação esquemática da }\\textit{Modelagem de Superpopulação}$", fig.align="center",out.width="50%"}
...
```{r, echo=FALSE, label=modelsuperpop,fig.align="center"}
suppressMessages(library(kableExtra))
...
```{r, echo=FALSE, label=Tab24,fig.align="center"}
suppressMessages(library(kableExtra))
...
tabela=as.data.frame(t(data.frame(l2,l3,l4)))
...
```{r, echo=FALSE, label=Tab25,fig.align="center"}
suppressMessages(library(kableExtra))
...
tabela=as.data.frame(t(data.frame(l2,l3)))

names(tabela) <-l1

knitr::kable(tabela,align= "cccc",format.args= list(big.mark = '.',dec=','),escape = F, booktabs=T,
caption= "$\\text{Distribuição de probabilidades condicional de }y\\text{ dado }x
\\text{ na população - }P( Y_i = y | X_i = x )$", row.names=FALSE)%>% 
kable_styling(full_width = F,latex_options = 'HOLD_position')%>%column_spec(column=1,width='4cm')%>%
column_spec(column=2,width='2cm')%>%column_spec(column=3,width='2cm')%>%column_spec(column=4,width='2cm')
```
...
```{r, echo=FALSE, label=Tab26,fig.align="center"}
suppressMessages(library(kableExtra))
...
```{r, echo=FALSE, label=Tab27,fig.align="center"}
suppressMessages(library(kableExtra))

l1=c('$x \\downarrow \\text{ | } y \\rightarrow$','0','1', 'Total')
l2=c('0', '0,875','0,125','1')
l3=c('1','0,500','0,500','1')
...
```{r, echo=FALSE, label=Tab28,fig.align="center"}
suppressMessages(library(kableExtra))

l1=c('$y$','0','1')
l2=c('$f_U(y)$','0,8000','0,2000')
l3=c('$f_s(y)$','0,6875','0,3125')
...
knitr::kable(tabela,align= "cccc",format.args= list(big.mark = '.',dec=','),escape = F, booktabs=T,
caption= "$\\text{Distribuição de probabilidades marginal de }Y\\text{ na população e na amostra - }
f_U(y)\\text{ e } f_s(y)$", row.names=FALSE)%>% 
