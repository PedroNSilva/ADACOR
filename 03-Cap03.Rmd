...
=======
onde $\mathbf{Y} = \sum_{i \in U} \mathbf{y}_i$ é o vetor de totais de $P$ variáveis de pesquisa.
>>>>>>> Stashed changes
=======
onde $\mathbf{Y} = \sum_{i \in U} \mathbf{y}_i$ é o vetor de totais de $P$ variáveis de pesquisa.
>>>>>>> Stashed changes
...
```{remark} 
A descrição do método *jackknife* aqui apresentada não cobre o caso de planos amostrais estratificados, que é mais complexo. Para detalhes sobre este caso, consulte @Wolter1985, pág. 174.
```
