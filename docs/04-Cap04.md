...
<caption>(\#tab:epakish1)\centering $\text{Efeitos de plano amostral de Kish para variáveis selecionadas}$ \newline $\text{Região Metropolitana do Rio de Janeiro}$</caption>
 <thead>
  <tr>
   <th style="text-align:left;"> Variável </th>
   <th style="text-align:center;"> Estimador Simples </th>
   <th style="text-align:center;"> Estimador de Razão </th>
   <th style="text-align:center;"> Estimador $\pi$-ponderado </th>
  </tr>
 </thead>
<tbody>
  <tr>
   <td style="text-align:left;width: 6cm; "> 1. Número total de moradores </td>
   <td style="text-align:center;width: 3cm; "> 10,74 </td>
   <td style="text-align:center;width: 3cm; "> 2,00 </td>
   <td style="text-align:center;width: 3.5cm; "> 1,90 </td>
  </tr>
  <tr>
   <td style="text-align:left;width: 6cm; "> 2. Número de moradores ocupados </td>
   <td style="text-align:center;width: 3cm; "> 5,78 </td>
   <td style="text-align:center;width: 3cm; "> 1,33 </td>
   <td style="text-align:center;width: 3.5cm; "> 1,28 </td>
  </tr>
  <tr>
   <td style="text-align:left;width: 6cm; "> 3. Rendimento monetário mensal </td>
   <td style="text-align:center;width: 3cm; "> 5,22 </td>
   <td style="text-align:center;width: 3cm; "> 4,92 </td>
   <td style="text-align:center;width: 3.5cm; "> 4,49 </td>
  </tr>
  <tr>
   <td style="text-align:left;width: 6cm; "> 4. Número total de filhos nascidos vivos de mulheres com 15 anos ou mais </td>
   <td style="text-align:center;width: 3cm; "> 4,59 </td>
   <td style="text-align:center;width: 3cm; "> 2,02 </td>
   <td style="text-align:center;width: 3.5cm; "> 1,89 </td>
  </tr>
  <tr>
   <td style="text-align:left;width: 6cm; "> 5. Número de domicílios que  têm fogão </td>
   <td style="text-align:center;width: 3cm; "> 111,27 </td>
   <td style="text-align:center;width: 3cm; "> 1,58 </td>
   <td style="text-align:center;width: 3.5cm; "> 1,55 </td>
  </tr>
  <tr>
   <td style="text-align:left;width: 6cm; "> 6. Número de domicílios que têm telefone </td>
   <td style="text-align:center;width: 3cm; "> 7,11 </td>
   <td style="text-align:center;width: 3cm; "> 7,13 </td>
   <td style="text-align:center;width: 3.5cm; "> 6,41 </td>
  </tr>
  <tr>
   <td style="text-align:left;width: 6cm; "> 7. Valor do aluguel ou prestação mensal </td>
   <td style="text-align:center;width: 3cm; "> 7,22 </td>
   <td style="text-align:center;width: 3cm; "> 7,02 </td>
   <td style="text-align:center;width: 3.5cm; "> 6,45 </td>
  </tr>
  <tr>
   <td style="text-align:left;width: 6cm; "> 8. Número de domicílios que têm automóvel e renda &lt; 5SM </td>
   <td style="text-align:center;width: 3cm; "> 1,80 </td>
  ...
  <tr>
   ...
   <td style="text-align:center;width: 3cm; "> 46,58 </td>
   <td style="text-align:center;width: 3cm; "> 2,26 </td>
   <td style="text-align:center;width: 3.5cm; "> 2,08 </td>
  </tr>
</tbody>
</table>
...
<table class="table" style="width: auto !important; margin-left: auto; margin-right: auto;">
<caption>(\#tab:estempr)$\text{Definição da estratificação da população de empresas}$</caption>
 <thead>
  <tr>
...
<table class="table" style="width: auto !important; margin-left: auto; margin-right: auto;">
<caption>(\#tab:proestmed)$\text{Propriedades dos estimadores da média das variáveis de pesquisa}$</caption>
 <thead>
  <tr>
...
<table class="table" style="width: auto !important; margin-left: auto; margin-right: auto;">
<caption>(\#tab:varest)$\text{Propriedades dos estimadores de variância do estimador ponderado da média}$</caption>
 <thead>
  <tr>
   <th style="text-align:left;"> Quantidade de interesse </th>
   <th style="text-align:right;"> Salários </th>
...
<table class="table" style="width: auto !important; margin-left: auto; margin-right: auto;">
<caption>(\#tab:eparec)$\text{Valores dos Efeitos de Plano amostral - EPA para as médias de Salário e Receita}$</caption>
 <thead>
  <tr>
   <th style="text-align:left;"> Variável </th>
...
<div class="figure">
<img src="04-Cap04_files/figure-html/epacong-1.png" alt="Valores de EPA e EPA de Kish para conglomeração" width="672" />
...
<table class="table" style="width: auto !important; margin-left: auto; margin-right: auto;">
<caption>(\#tab:procob)$\text{Probabilidades de cobertura para níveis nominais de 0,95 e 0,99}$</caption>
 <thead>
  <tr>
   <th style="text-align:center;"> $\mathbf{EPA}\left( \hat{\theta},v_{0}\right)$ </th>
...
<table class="table" style="width: auto !important; margin-left: auto; margin-right: auto;">
<caption>(\#tab:nivsig)\centering $\text{Níveis de significância verdadeiros, em porcentagem, do teste T2 para o nível nominal}$ \newline $\text{de 5 por cento  assumindo autovalores iguais a }\delta$</caption>
 <thead>
  <tr>
