...
{\centering \includegraphics[width=0.5\linewidth]{Figuras/Figura2.1} 
...
{\centering \includegraphics[width=0.5\linewidth]{Figuras/Figura2.2} 
...
{\centering \includegraphics[width=0.5\linewidth]{Figuras/Figura2.3} 
...
adequados na análise, como pode ser visto em @Silva2020 e no Capítulo \@ref(capplanamo). 
