...
\caption{Representação esquemática da *Modelagem Clássica*}(\#fig:modclas)
\end{figure}
...
\caption{Representação esquemática da *Amostragem Probabilística*}(\#fig:modamo)
\end{figure}
...
\caption{Representação esquemática da *Modelagem de Superpopulação*}(\#fig:modsup)
\end{figure}
