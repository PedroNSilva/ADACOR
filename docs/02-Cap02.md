...
\caption{(\#tab:modelclass)Representação esquemática da abordagem Modelagem Clássica}
\centering
...
\caption{(\#tab:modelamo)Representação esquemática da abordagem Amostragem Probabilística}
\centering
\begin{tabular}[t]{>{\raggedright\arraybackslash}p{4.5cm}l}
\toprule
...
\caption{(\#tab:modelsuperpop)Representação esquemática da Modelagem de Superpopulação}
\centering
...
\caption{(\#tab:Tab24)Distribuição de probabilidades conjunta na população $Pr( Y_i = y ; X_i = x )$}
\centering
...
\caption{(\#tab:Tab25)Distribuição de probabilidades condicional de $y$ dado $x$ na população - $Pr( Y_i = y | X_i = x )$}
\centering
\begin{tabular}[t]{>{\centering\arraybackslash}p{2cm}>{\centering\arraybackslash}p{2cm}>{\centering\arraybackslash}p{2cm}>{\centering\arraybackslash}p{2cm}}
\toprule
$x/y$ & 0 & 1 & Total\\
...
\caption{(\#tab:Tab26)Distribuição de probabilidades conjunta na população $f_U( x ; y )$}
\centering
\begin{tabular}[t]{>{\centering\arraybackslash}p{2cm}>{\centering\arraybackslash}p{2cm}>{\centering\arraybackslash}p{2cm}>{\centering\arraybackslash}p{2cm}}
\toprule
$x/y$ & 0 & 1 & Total\\
...
\caption{(\#tab:Tab27)Distribuição de probabilidades condicional de $Y$ dado $X$ na população - $f_U( y | x )$}
\centering
\begin{tabular}[t]{>{\centering\arraybackslash}p{2cm}>{\centering\arraybackslash}p{2cm}>{\centering\arraybackslash}p{2cm}>{\centering\arraybackslash}p{2cm}}
\toprule
$x/y$ & 0 & 1 & Total\\
...
\caption{(\#tab:Tab28)Distribuição de probabilidades marginal de $Y$ na população - $f_U( y )$}
\centering
