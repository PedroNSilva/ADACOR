...
<div class="figure">
<img src="Figuras/Figura2.1.png" alt="Representação esquemática da *Modelagem Clássica*"  />
<p class="caption">(\#fig:modclas)Representação esquemática da *Modelagem Clássica*</p>
</div>
...
<div class="figure">
<img src="Figuras/Figura2.2.png" alt="Representação esquemática da *Amostragem Probabilística*"  />
<p class="caption">(\#fig:modamo)Representação esquemática da *Amostragem Probabilística*</p>
</div>
...
considerando os pontos i) a iii) do Capítulo \@ref(introduc). Veja uma representação gráfica
resumida desta abordagem na Figura \@ref(fig:modsup).

<div class="figure">
<img src="Figuras/Figura2.3.png" alt="Representação esquemática da *Modelagem de Superpopulação*"  />
<p class="caption">(\#fig:modsup)Representação esquemática da *Modelagem de Superpopulação*</p>
</div>
...
<tbody>
  ...
  <tr>
   ...
   <td style="text-align:left;"> $\text{Inferir sobre }g\left( y_{1}, \ldots , y_{N} \right) \text{ partir de } y_{i_1}, \ldots, y_{i_n} \text{ usando } p(a)$ </td>
  </tr>
</tbody>
</table>
...
A título de recordação, serão apresentados na Seção \@ref(planamo) alguns resultados básicos da *Amostragem Probabilística*. A ênfase do texto, porém, será na apresentação da *Modelagem de Superpopulação*, sendo para isto apresentados os
...
<table class="table" style="width: auto !important; margin-left: auto; margin-right: auto;">
<caption>(\#tab:Tab24)$\text{Distribuição de probabilidades conjunta na população }Pr( Y_i = y ; X_i = x )$</caption>
<tbody>
  <tr>
...
<table class="table" style="width: auto !important; margin-left: auto; margin-right: auto;">
<caption>(\#tab:Tab25)$\text{Distribuição de probabilidades condicional de }y\text{ dado }x\text{ na população - }Pr( Y_i = y | X_i = x )$</caption>
<tbody>
  <tr>
   <td style="text-align:center;width: 4cm; "> $x \downarrow \text{ | } y \rightarrow$ </td>
   <td style="text-align:center;width: 2cm; "> 0 </td>
...
<table class="table" style="width: auto !important; margin-left: auto; margin-right: auto;">
<caption>(\#tab:Tab28)$\text{Distribuição de probabilidades marginal de }Y\text{ na população - }f_U( y )$</caption>
<tbody>
  <tr>
