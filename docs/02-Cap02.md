...
<img src="Figuras/Figura2.1.png" alt="$\text{Representação esquemática da }\textit{Modelagem Clássica}$" width="382" />
...
<tbody>
  ...
  <tr>
   ...
   <td style="text-align:left;"> $Y_1, \ldots , Y_n 
     \text{ variáveis aleatórias IID com distribuição } f(y,\theta) \text{ onde } \theta \in \Theta$ </td>
  </tr>
  <tr>
...
<div class="figure" style="text-align: center">
<img src="Figuras/Figura2.2.png" alt="$\text{Representação esquemática da }\textit{Amostragem Probabilística}$" width="315" />
...
<div class="figure" style="text-align: center">
<img src="Figuras/Figura2.3.png" alt="$\text{Representação esquemática da }\textit{Modelagem de Superpopulação}$" width="316" />
