...
\begin{figure}
\includegraphics[width=10,6in]{Figuras/Figura2.1} \caption{Representação esquemática da Modelagem Clássica}(\#fig:modclas)
\end{figure}
...
\begin{figure}
\includegraphics[width=10,81in]{Figuras/Figura2.2} \caption{Amostragem Probabilística}(\#fig:modamo)
\end{figure}
...
\begin{figure}
\includegraphics[width=10,88in]{Figuras/Figura2.3} \caption{Modelagem de Superpopulação}(\#fig:modsup)
\end{figure}
